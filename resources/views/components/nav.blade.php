...
<nav id="navbar" class="navbar fixed-top navbar-expand-lg bg-white">
    ...
    <button class="navbar-toggler awesome-menu mt-1" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
        <span class="navbar-toggler-icon mt-1 p-0"> <i class="fas fa-bars"></i> </span>
    </button>
    ...
    <div class="collapse navbar-collapse ml-3" id="navbarSupportedContent">
        ...
        <div class="collapse navbar-collapse mr-0" id="#exampleModalCenter">
            ...
            <ul class="navbar-nav ml-auto pl-md-3 col-12 col-md-4 align-items-center text-left m-0 ">
